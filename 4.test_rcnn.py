...
from utils.utils_func import iou
...
def draw_box_with_text(img, rect_list, score_list):
    ...
    for i in range(len(rect_list)):
        ...
        cv2.rectangle(
            img, (xmin, ymin), (xmax, ymax), color=(0, 0, 255), thickness=1)
        cv2.putText(
            img, "{:.3f}".format(score), (xmin, ymin),
...
if __name__ == '__main__':
    ...
    test_img_path = './imgs/26f0-fzrwiaz0595636.jpg'
    ...
    # 候选区域建议
    selective_search.config_get_img_method(gs, img, strategy='f')
