...
from utils.custom_bbox_regression_dataset import BBoxRegressionDataset
...
def train_model(
    ...
    for epoch in range(num_epochs):
        ...
        # 每训练一轮就保存
        save_model(model, './pth/bbox_regression_%d.pth' % epoch)
...
def get_model(device=None):
    ...
    model.load_state_dict(torch.load('./pth/best_linear_svm_AlexNet_car.pth'))
    model.eval()
...
if __name__ == '__main__':
    data_loader = load_data('./DATA/voc_car/bbox_regression')
